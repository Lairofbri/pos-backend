...
INSERT INTO categorias (id, tenant_id, nombre, orden, color) VALUES
  ('c1000000-0000-0000-0000-000000000001', 'a0000000-0000-4000-8000-000000000001', 'Entradas',       1, '#FF6B6B'),
  ('c1000000-0000-0000-0000-000000000002', 'a0000000-0000-4000-8000-000000000001', 'Platos fuertes', 2, '#4ECDC4'),
  ('c1000000-0000-0000-0000-000000000003', 'a0000000-0000-4000-8000-000000000001', 'Bebidas',        3, '#45B7D1'),
  ('c1000000-0000-0000-0000-000000000004', 'a0000000-0000-4000-8000-000000000001', 'Postres',        4, '#96CEB4')
ON CONFLICT DO NOTHING;

INSERT INTO productos (tenant_id, categoria_id, nombre, precio, orden) VALUES
  ('a0000000-0000-4000-8000-000000000001', 'c1000000-0000-0000-0000-000000000001', 'Sopa del día',       3.50, 1),
  ('a0000000-0000-4000-8000-000000000001', 'c1000000-0000-0000-0000-000000000001', 'Ensalada mixta',     4.00, 2),
  ('a0000000-0000-4000-8000-000000000001', 'c1000000-0000-0000-0000-000000000002', 'Pollo a la plancha', 8.50, 1),
  ('a0000000-0000-4000-8000-000000000001', 'c1000000-0000-0000-0000-000000000002', 'Carne asada',       12.00, 2),
  ('a0000000-0000-4000-8000-000000000001', 'c1000000-0000-0000-0000-000000000002', 'Pasta al pesto',     7.50, 3),
  ('a0000000-0000-4000-8000-000000000001', 'c1000000-0000-0000-0000-000000000003', 'Agua natural',       1.00, 1),
  ('a0000000-0000-4000-8000-000000000001', 'c1000000-0000-0000-0000-000000000003', 'Refresco',           1.50, 2),
  ('a0000000-0000-4000-8000-000000000001', 'c1000000-0000-0000-0000-000000000003', 'Jugo natural',       2.50, 3),
  ('a0000000-0000-4000-8000-000000000001', 'c1000000-0000-0000-0000-000000000004', 'Flan',               2.50, 1),
  ('a0000000-0000-4000-8000-000000000001', 'c1000000-0000-0000-0000-000000000004', 'Pastel del día',     3.00, 2)
ON CONFLICT DO NOTHING;
